...
class WhisperModel:
    def __init__(self, model_path="/mnt/ks/Works/asr/from_whisper/whisper-small-ky/checkpoint-3000", processor_path="/mnt/ks/Works/asr/from_whisper/whisper-small-ky"):
